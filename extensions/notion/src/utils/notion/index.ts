...
import { Color, Icon, type ColorLike } from "@vicinae/api";
...
export type NotionObject = UnwrapArray<
	UnwrapPromise<ReturnType<Client["search"]>>["results"]
>;

type Markdown = string;
export type PageContent = Markdown | BlockObjectRequest[];
export function isMarkdownPageContent(
	content: PageContent,
): content is Markdown {
...
export function isType<
	P extends DatabaseProperty | PageProperty,
	T extends PageProperty["type"],
>(
...
export function notionColorToTintColor(
	...
	const colorMapper: Record<string, ColorLike> = {
