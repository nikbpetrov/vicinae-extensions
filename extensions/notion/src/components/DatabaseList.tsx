...
export function DatabaseList({
	...
	const [sort, setSort] = useState<"last_edited_time" | "created_time">(
		"last_edited_time",
	);
	const {
		data: databasePages,
		...
		(databaseId, searchText, sort) =>
			queryDatabase(databaseId, searchText, sort),
		[databaseId, searchText, sort],
	);
		...
		<List
			...
			searchBarAccessory={
				<List.Dropdown
					...
					storeValue
					onChange={(value) =>
						setSort(value as "last_edited_time" | "created_time")
					}
				>
