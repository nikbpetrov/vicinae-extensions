	...
	const page: Page = {
		...
		created_by:
			"created_by" in notionPage && notionPage.created_by.object === "user"
				...
				: undefined,
		parent_page_id:
			"parent" in notionPage && "page_id" in notionPage.parent
		...
		parent_database_id:
			"parent" in notionPage && "database_id" in notionPage.parent
				...
				: undefined,
		last_edited_time:
			"last_edited_time" in notionPage
				? new Date(notionPage.last_edited_time).getTime()
				: undefined,
		last_edited_user:
			"last_edited_by" in notionPage &&
			notionPage.last_edited_by.object === "user"
				? notionPage.last_edited_by.id
				: undefined,
		icon_emoji:
			"icon" in notionPage && notionPage.icon?.type === "emoji"
				? notionPage.icon.emoji
				: null,
		icon_file:
			"icon" in notionPage && notionPage.icon?.type === "file"
				? notionPage.icon.file.url
				: null,
		icon_external:
...
export function getLocalTimezone() {
	return Intl.DateTimeFormat().resolvedOptions().timeZone as TimeZoneRequest;
}
